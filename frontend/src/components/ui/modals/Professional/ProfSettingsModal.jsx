...
const ProSettingsModal = ({ open, setOpen }) => {
    ...
    const [salon_name, setSalonName] = useState(userData?.user?.salon_name || "");
    ...
    const [cancellation_policy, setcancellation_policy] = useState(userData?.user?.cancellation_policy || "")
    ...
    const handleClick = (e) => {
        ...
        mutation.mutate({
            ...
            address_line2,
            pincode,
            salon_name, // Use the formatted name
            city,
            state,
            country,
            cancellation_policy,
                                    ...
                                    <form onSubmit={(e) => handleClick(e)} className='mt-[50px] px-[10px] space-y-[15px] max-h-[400px] lg:max-h-[450px] overflow-auto'>
                                        ...
                                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-[15px]'>
                                            ...
                                            <div>
                                                ...
                                                <InputFeild isSetting={true}
                                                    placeholder={'The Choppers in the cut barber lounge, US'}
                                                    value={description}
